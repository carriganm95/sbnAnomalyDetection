...
- Smaller strides produce smoother, more stable score distributions by increasing overlap between consecutive windows.
...
- Within an intermediate window-size range, the per-channel anomaly-score pattern changes: separation weakens, then reappears with peaks shifted from the centers of the induction planes toward plane junctions.
